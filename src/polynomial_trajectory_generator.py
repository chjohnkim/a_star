...
#Input: Waypoints as an array of 3 element vectors
#Output: Position and Velocity trajectory as a function of time 
def trajectory_generator(waypoints):
    ...
    while not rospy.is_shutdown():
        ...
        mark_reference(marker_pub, test_map[0],"blue", id=0) # Mark start point
        for i in range(1,len(test_map)-1):
            mark_reference(marker_pub, test_map[i],"red", id=i) # Mark obstacles
        mark_reference(marker_pub, test_map[-1],"green", id=100) # Mark end point 
